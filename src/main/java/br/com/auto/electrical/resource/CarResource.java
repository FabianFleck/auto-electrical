...
public class CarResource {
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Update car details", description = "Update existing car details by ID")
    public ResponseEntity<CarResponse> updateCustomer(@PathVariable Long id, @RequestBody CarRequest request) {
